...
export async function getAppBootstrap(
  ...
  return {
    ...
    settings: {
      ...
      klaviyoConfigured: Boolean(shop.klaviyoApiKey),
      klaviyoEnabled: shop.klaviyoEnabled,
      klaviyoLastEventAt: shop.klaviyoLastEventAt?.toISOString() ?? null,
      klaviyoLastError: shop.klaviyoLastError ?? null,
      ...
      priorityOrderValueThresholdCents,
      vipTagPattern,
      senderName: shop.senderName ?? null,
      senderEmail: shop.senderEmail ?? null,
      senderVerified: shop.senderVerified ?? false,
      replyToEmail: shop.replyToEmail ?? null,
      digestEmailEnabled: shop.digestEmailEnabled ?? false,
      digestEmailRecipient: shop.digestEmailRecipient ?? null,
      emailDigestHour: shop.digestHour ?? 9,
      emailRules,
      slackRules,
    },
    assumptions: [
